  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-phone d-flex align-items-center"><span>+57 310 333 55 66</span></i>
    ...
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          ...
          <h2>Seguimos entregando deliciosas hamburguesas de gran calidad!</h2>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>NOSOTROS..</h3>
            <p class="fst-italic">
              Somos una pequeña familia quienes de manera artesanal, cultivamos gran parte de nuestros productos sin químicos ni conservantes, nuestro pan esta hecho con sémola de gran calidad para deleyte de su paladar.
            </p>
            <ul>
